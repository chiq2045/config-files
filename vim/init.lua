...
require('packer').startup(function(use)
  ...
  use 'b0o/SchemaStore.nvim' -- Access to the schema store catalog
...
vim.keymap.set('n', '<c-n>', ':NvimTreeToggle<cr>', { desc = '[N] Toggle File Explorer' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>f', vim.lsp.buf.format, '[C]ode [A]ction')
